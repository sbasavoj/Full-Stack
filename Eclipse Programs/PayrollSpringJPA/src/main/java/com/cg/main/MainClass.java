...
public class MainClass {
	public static void main(String[] args) {
		...
		try {
			int associateId=payrollServices.acceptAssociateDetails(10000, "Vidya", "Basavoju", "Java", "Trainee", "AJSU123", "vidya@gmail.com", 6000, 1000, 1000, 123456, "ICICI", "ICICI123");
		    ...
		    payrollServices.deleteAssociateDetails(associateId);
